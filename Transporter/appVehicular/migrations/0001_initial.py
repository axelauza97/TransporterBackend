# Generated by Django 2.2.7 on 2021-02-03 18:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coordStart', models.CharField(blank=True, max_length=200, null=True)),
                ('coordEnd', models.CharField(blank=True, max_length=200, null=True)),
                ('startAddress', models.CharField(blank=True, max_length=200, null=True)),
                ('endAddress', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('idTypePaymentService', models.ForeignKey(db_column='idPayment', on_delete=django.db.models.deletion.DO_NOTHING, to='appVehicular.Payment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idCompanyFare', models.ForeignKey(db_column='idCompany', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='appVehicular.Company')),
                ('idTypeServiceFare', models.ForeignKey(db_column='idTypeService', on_delete=django.db.models.deletion.DO_NOTHING, to='appVehicular.TypeService')),
            ],
        ),
        migrations.CreateModel(
            name='Employee',
