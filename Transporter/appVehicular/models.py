...
class Driver(models.Model):
    ...
    def __str__(self):
       return '%s: %s %s %s' % (self.idDriver, self.userDriver.username, self.rateDriver, self.vehicleDriver)
...
class Client(models.Model):
    ...
    def __str__(self):
       return '%s: %s %s' % (self.idClient, self.userClient.username, self.rateClient)
...
class Service(models.Model):
    ...
    def __str__(self):
       return '%s: %s %s %s %s' % (self.idService, self.endidLocation, self.startDate, self.endDate)
